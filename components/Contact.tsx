  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start rtl:text-right">
        ...
        {formStatus === 'sent' ? (
          <div className="bg-prt-dark-green/50 border border-prt-accent text-prt-light-gray p-8 text-center h-full flex flex-col justify-center">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <textarea id="message" placeholder={contactTranslations.form.message} rows={5} required className="w-full bg-black/40 border border-prt-muted-gray/30 p-3 text-prt-light-gray focus:ring-2 focus:ring-prt-accent focus:border-prt-accent outline-none transition-all rtl:text-right"></textarea>
            </div>
            <div>
              <button type="submit" disabled={formStatus === 'sending'} className="w-full bg-prt-accent text-prt-dark-gray font-bold py-3 px-8 hover:bg-white transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed">
