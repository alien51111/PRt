...
const kuTranslations: Translations = {
    ...
    insights: {
        ...
        items: [
            ...
            { 
              ...
              expertImage: "https://images.unsplash.com/photo-1566753323558-f4e0952af115?q=80&w=1287&auto=format&fit=crop",
              content: [
                  "ناوبانگ ساڵانێکی دەوێت بۆ بونیادنان و خولەکێک بۆ لەناوبردن. لە قەیراندا، بێدەنگی بژاردە نییە؛ بەڵکو دانپێدانانە. ڕۆڵی سەرەکی پەیوەندییە گشتییەکان کۆنترۆڵکردنی گێڕانەوەکەیە پێش ئەوەی بگۆڕێت.",
    ...
    projects: {
        ...
        items: [
            ...
            },
            {
                ...
                image: "https://iraqbritainbusiness.org/wp-content/uploads/2018/11/Iraq-Tech-Conference-Pic-1.jpg",
                overview: "ڕووداوێکی تەکنەلۆژی زیندوو کە ئاراستەی گەنجان کراوە و بە هاوکاری لەگەڵ دامەزراوە ئەکادیمییەکان ئەنجامدراوە، تیشک دەخاتە سەر ئاراستە تەکنەلۆژییە سەرهەڵداوەکان و ئیلهام دەبەخشێت بە نەوەی داهاتووی داهێنەرانی تەکنەلۆژیا و خاوەنکارە عێراقییەکان.",
                approach: [
                    "دانیشتنی کارلێککەر، پانێڵی گفتوگۆ، و نمایشی زیندووی ڕێکخست کە تیشک دەخەنە سەر نوێترین تەکنەلۆژیاکان.",
                    "ئاسانکاری کرد بۆ هاوکاری لە نێوان ناوەندە ئەکادیمییەکان، کۆمپانیاکانی تەکنەلۆژیا، و کۆمەڵگاکانی کارساز."
                ],
                impact: [
                    "بە سەرکەوتوویی هەزاران بەشداربووی بەشداری پێکرد، هۆشیاری بەرزکردەوە دەربارەی دەرفەتەکانی بواری تەکنەلۆژیا.",
                    "پەیوەندییەکانی لەگەڵ کۆمەڵگا و لایەنە پەیوەندیدارەکان بەهێز کرد."
                ]
            }
        ],
        disclaimer: "پرۆژەکان کە لەم پرۆفایلەدا خراونەتەڕوو تەنها نمونەی هەڵبژێردراون - هەڵمەتە جیاوازەکان کە تواناکانمان دەردەخەن. ئەمە تەواوی چیرۆکەکە نییە. لە پشت پەردەوە، PRt دەیان دەستپێشخەری دیکەی بەڕێوەبردووە لە کەرتە جیاوازەکان و شارەکان. هەر پرۆژەیەک هەڵگری مۆری ئێمەیە: ستراتیژی بیرلێکراوە، شارەزایی کولتووری، و پابەندبوون بە ئەنجامەکان.",
        proofInPractice: {
            title: "سەلماندن لە پراکتیکدا",
            items: [
                {
                    title: "وەرچەرخانی پەیوەندییەکان",
                    description: "لە زاخۆوە تا بەسرە، PRt گفتوگۆی نیشتمانی بۆ کۆمپانیا پێشەنگەکانی پەیوەندی لە عێراق دروستکرد. لە ڕێگەی ئەزموونی قوڵ و چیرۆکبێژی بەداتا، ئێمە زیاتر لە ٢٠ ملیۆن دڵی بەیەکەوە بەستەوە."
                },
                {
                    title: "دیدگای دارایی نیشتمانی",
                    description: "بە هاوبەشی لەگەڵ لایەنە پەیوەندیدارە نیشتمانییەکان، PRt ستراتیژی پەیوەندی بۆ یەکێک لە گرنگترین دەستپێشخەرییە ئابوورییەکانی عێراق داڕشت."
                },
                {
                    title: "بەهێزکردنی داهێنەران",
                    description: "لە دەرکەوتنی بوێرانەی براندی BYD تا گەشەسەندنی کات بەسەربردن لە عێراق مۆڵ، PRt ئاهەنگ دەگێڕێت بۆ داهێنان و بەرهەمداری لە پیشەسازییە جیاوازەکاندا."
                }
            ]
        }
    },
    valueStats: [
        { value: 3.5, label: "ساڵانە بەڕێوەدەبرێت لە پەیوەندییە ستراتیژییەکانی کڕیاردا", prefix: '$', suffix: 'M+', decimals: 1 },
        { value: 2, label: "نووسینگەی ستراتیژی لەگەڵ کۆگای تایبەت" },
        { value: 300, label: "پێشخەری مەیدانی پیشەیی لە سەرانسەری وڵات", suffix: '+' },
        { value: 30, label: "ئەندامی تیم لە سەرانسەری ناوچەکە", suffix: '+' }
    ],
    clients: {
        title: "کڕیارەکان و هاوبەشییەکان",
        subtitle: "گەشتەکەمان هاوبەشی لەگەڵ سەرکردەکانی پیشەسازی، ڕێکخراوە جیهانییەکان، و کۆمپانیا ناوخۆییە کاریگەرەکان لەخۆدەگرێت. ئەوان متمانە بە ئێمە دەکەن بۆ گێڕانەوەی چیرۆکەکانیان - کە ڕێگەمان دەدات دەنگیان بەرز بکەینەوە و مەودای گەیشتنیان فراوان بکەین.",
        logos: enTranslations.clients.logos
    },
    careers: {
        title: "بەشداری تیمەکەمان بکە",
        subtitle: " ببە بە بەشێک لە تیمێک کە پەیوەندییەکان لە دڵی عێراق پێناسە دەکاتەوە. ئێمە بەدوای کەسانی بەشەوق و داهێنەردا دەگەڕێین بۆ یارمەتیدانمان لە داڕشتنی نەوەی داهاتووی گێڕانەوەکان.",
        culture: {
            title: "کولتووری ئێمە",
            text: "ئێمە ژینگەیەکی هاوکاری و داهێنەرانە دابین دەکەین کە تێیدا گوێ لە هەموو دەنگێک دەگیرێت و بەهای بۆ دادەنرێت. باوەڕمان بە فێربوونی بەردەوام، گەشەی پیشەیی، و پاراستنی هاوسەنگی تەندروستی نێوان کار و ژیان هەیە.",
            perks: {
                title: "ئەوەی پێشکەشی دەکەین",
                items: ["مووچەی کێبڕکێکار", "سوودەکانی تەندروستی و خۆشگوزەرانی", "پەرەپێدانی پیشەیی", "کاتژمێری کارکردنی نەرم", "ئازادی داهێنان", "گەشتی تیم"]
            },
        },
        openings: {
            title: "هەلە کراوەکان",
            ...
            jobs: [
                { title: "بەڕێوەبەری پەیوەندییە گشتییەکان", location: "بەغدا", type: "تەواو کات" },
                { title: "پسپۆڕی میدیای دیجیتاڵ", location: "سلێمانی", type: "تەواو کات" },
                { title: "دیزاینەری گرافیک", location: "بەغدا", type: "گرێبەست" },
                { title: "ڕێکخەری چالاکییەکان", location: "دوورکاری/نیشتمانی", type: "نیوە کات" }
            ]
        }
    },
    contact: {
        title: "با پێکەوە داهێنان بکەین",
        subtitle: "چیرۆکێکت هەیە بیڵێیت یان تەحەدایەک بۆ چارەسەرکردن؟ ئێمە لێرەین بۆ گوێگرتن و هاوکاریکردن.",
        details: {
            title: "پەیوەندی بکە",
            address: "١٢٣ شەقام، مەنسوور، بەغدا، عێراق",
            email: "hello@prt.iq",
            phone: "+964 780 123 4567"
        },
        form: {
    ...
    footer: {
        subtitle: "پردێک لە نێوان کەلەپوور و داهێنان",
        email: "hello@prt.iq",
